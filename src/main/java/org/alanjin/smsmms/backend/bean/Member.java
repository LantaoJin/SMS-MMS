...
public class Member {
    ...
    public Member(String memId, String name, int sex, Date birthday,
            Date joinDate, BigDecimal feeSum) {
        this.memId = memId;
        this.name = name;
        this.gender = sex;
    ...
    public String toString() {
        return "Member [memId=" + memId + ", name=" + name + ", gender="
                + gender + ", birthday=" + birthday + ", zip=" + zip
                + ", address=" + address + ", tel=" + tel + ", phone=" + phone
